...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            Fraction statistic_2 = fractionList_2.minFraction();

            double statistic_3 = fractionList_1.countBigger(rand1, rand2);
            double statistic_4 = fractionList_2.countSmaller(rand2, rand1);

            System.out.printf("\nMax fraction in fractionlist_1:\t %s;\n", statistic_1);
            System.out.printf("Min fraction in fractionlist_2:\t %s;\n\n", statistic_2);

            System.out.printf("More than random fraction - (%.1f / %.1f) in fractionlist_1:\t %.0f;\n", rand1, rand2, statistic_3);
            System.out.printf("Less than random fraction - (%.1f / %.1f) in fractionlist_2:\t %.0f;\n\n", rand2, rand1, statistic_4);
